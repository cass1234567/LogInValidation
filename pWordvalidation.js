...
document.getElementById("bntcompute").addEventListener("click" , getUser);  //addEventListener is abuilt in function in javascript that allows you to attach an event handler to specified element such as a button or link.
...
document.getElementById("bntcompute").addEventListener("click", get);